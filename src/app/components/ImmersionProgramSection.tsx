...
export function ImmersionProgramSection() {
  return (
    <section className="relative py-32 overflow-hidden" style={{ backgroundColor: '#FAFAF8' }}>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-8 flex flex-col gap-20">
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-2xl p-8 border-2" style={{ borderColor: '#1C1C1E' }}>
        ...
        <div className="flex flex-col gap-8 max-w-4xl mx-auto">
          <h3 className="text-2xl font-light text-center" style={{ color: '#1C1C1E' }}>
          ...
          <div className="flex flex-col gap-4">
            {programElements.map((element, index) => (
              <div key={index} className="flex items-start gap-4 bg-white rounded-lg p-4">
                <div className="w-2 h-2 rounded-full shrink-0 mt-2" style={{ backgroundColor: '#B87333' }} />
        ...
        <div className="rounded-2xl p-12 max-w-5xl mx-auto" style={{ backgroundColor: '#1C1C1E' }}>
          <div className="flex flex-col gap-6 text-center">
            <div className="flex justify-center">
              <Compass className="w-12 h-12" style={{ color: '#B87333' }} />
            </div>
