 ...
 * - Section: Background Deep Blue (#1A2A3A), Padding: 128px 0
...
export function ProblemAccessSection() {
  return (
    <section className="relative py-32 overflow-hidden" style={{ backgroundColor: '#1A2A3A' }}>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-8 flex flex-col gap-16">
        ...
        <div className="flex flex-col gap-6 text-center max-w-4xl mx-auto">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-light text-white leading-tight">
            Un environnement{" "}
            <span className="font-serif italic" style={{ color: '#C9A96E' }}>exigeant</span>
          </h2>
          ...
          {problems.map((problem, index) => (
            ...
            >
              ...
              <div className="shrink-0 mt-1">
                <problem.icon className="w-6 h-6" style={{ color: '#C9A96E' }} />
              </div>
