        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-3">
              <a href="#immersion" className="flex items-center gap-2 text-white/60 transition-colors text-sm" style={{ color: 'rgba(255,255,255,0.6)' }} onMouseEnter={(e) => e.currentTarget.style.color = '#B87333'} onMouseLeave={(e) => e.currentTarget.style.color = 'rgba(255,255,255,0.6)'}>
                <span className="w-1 h-1 rounded-full shrink-0" style={{ backgroundColor: '#B87333' }} />
                Programme Immersion
              </a>
              <a href="#accompagnement" className="flex items-center gap-2 text-white/60 transition-colors text-sm" style={{ color: 'rgba(255,255,255,0.6)' }} onMouseEnter={(e) => e.currentTarget.style.color = '#B87333'} onMouseLeave={(e) => e.currentTarget.style.color = 'rgba(255,255,255,0.6)'}>
                <span className="w-1 h-1 rounded-full shrink-0" style={{ backgroundColor: '#B87333' }} />
                Accompagnement
              </a>
              <a href="#implantation" className="flex items-center gap-2 text-white/60 transition-colors text-sm" style={{ color: 'rgba(255,255,255,0.6)' }} onMouseEnter={(e) => e.currentTarget.style.color = '#B87333'} onMouseLeave={(e) => e.currentTarget.style.color = 'rgba(255,255,255,0.6)'}>
                <span className="w-1 h-1 rounded-full shrink-0" style={{ backgroundColor: '#B87333' }} />
                Implantation
              </a>
            </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-start gap-3 text-white/60 text-sm">
                <MapPin className="w-4 h-4 shrink-0 mt-1" style={{ color: '#B87333' }} />
                <span>King Fahd Road - Hamad Tower</span>
              </div>
              <div className="flex items-center gap-3 text-white/60 text-sm">
                <Mail className="w-4 h-4 shrink-0" style={{ color: '#B87333' }} />
                <a
